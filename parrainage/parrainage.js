...
//   var dropdown = countries.dropdown(document.getElementById("dropdown"), {
//     data: countries,
//     autocomplete: true,
//     multiple: true,
//     width: "180px",
...
//   });
  ...
  //   franceOption.text;
    ...
    // Add a focus event listener to trigger the animation on input focus
    input.addEventListener('focus', () => {
        input.style.animation = 'none'; // Remove the animation
        setTimeout(() => {
            input.style.animation = 'slideIn 0.5s ease'; // Add the animation back
        }, 0);
    });
    //copie placeholder
  ...
  //     alert('Placeholder text copied: ' + input.placeholder);
  // }
  function copyPlaceholder() {
    const input = document.getElementById('username');
